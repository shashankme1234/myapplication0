...
public class Myapplication0App {

    private static final Logger log = LoggerFactory.getLogger(Myapplication0App.class);

    private final Environment env;

    public Myapplication0App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes myapplication0.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Myapplication0App.class);
